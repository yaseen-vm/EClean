                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="contact-form">
                            <form enctype="multipart/form-data" method="post" action="Assets/ActionPages/WorkerUploadAction.jsp">
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <fieldset>
                                            <input  type="file" style="background: white"  id="file_photo" name="file_photo1"  required="">
                                        </fieldset>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <fieldset>
                                            <input  type="file" style="background: white" id="file_proof" name="file_proof1"  required="">
                                        </fieldset>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                        <fieldset>
