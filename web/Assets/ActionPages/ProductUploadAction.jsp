...
//checking if request cotains multipart data
    ...
    if (isMultipart) {
        ...
        String InsQry = "INSERT INTO `tbl_product`(product_name,product_details,subcategory_id,product_photo,product_rate,shop_id,brand_id)"
                + "values('" + value[0] + "','" + value[1] + "','" + value[3] + "','" + photo + "','" + value[4] + "','"+session.getAttribute("sid")+"','" + value[5] + "')";
