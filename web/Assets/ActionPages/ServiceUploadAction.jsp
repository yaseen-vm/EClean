...
//checking if request cotains multipart data
    ...
    if (isMultipart) {
        ...
        while (itr.hasNext())//checking if there is any value in the position like rs.next()
        {
            ...
            } else//when it is an image or multipart
            {
                ...
                if (field_name.equals("file_photo"))//write the name of image here it is img_product
                {
                    ...
                    photo = "worker_Photo" + r_num + ext;//generating random number for images so this name and format of imagewil be stored inside the server
        ...
        String InsQry = "INSERT INTO `tbl_service`(service_title,service_details,service_photo,worker_id,service_amount)"
                + "values('" + value[0] + "','" + value[1] + "','" + photo + "','"+session.getAttribute("wid")+"','" + value[4] + "')";
...
<script type="text/javascript">
    ...
    setTimeout(function() {
        window.location.href = '../../worker/Service.jsp'
