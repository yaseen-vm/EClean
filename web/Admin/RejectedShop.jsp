...
<html lang="en" >
    ...
    <body>
        ...
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                <%                    int i = 0;
                    String selQry = "select * from tbl_shop c inner join tbl_place p on p.place_id=c.place_id inner join tbl_district d on d.district_id=p.district_id where shop_status='2'";
                ...
                <tr>
                    ...
                    <td align="center">
                        <a href="RejectedShop.jsp?aid=<%=rs.getString("shop_id")%>"><img src="../Assets/Template/admin/check.png" width="25" height="25"></a>
                    </td>
                </tr>
                <%
                    }
