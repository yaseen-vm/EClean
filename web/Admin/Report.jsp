    ...
    <body>
        ...
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                <%                    
                    int i = 0;
                    String selQry = "select * from tbl_cart c inner join tbl_booking b on b.booking_id=c.booking_id inner join tbl_product p on p.product_id=c.product_id INNER join tbl_user u on u.user_id=b.user_id inner join tbl_shop s on s.shop_id=p.shop_id where booking_status=2";
