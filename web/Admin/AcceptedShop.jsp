...
<html lang="en" >
    ...
    <%        if (request.getParameter("aid") != null) {
            ...
            String upQry = "update tbl_shop set shop_status='1' where shop_id='" + request.getParameter("aid") + "'";
        ...
        if (request.getParameter("rid") != null) {
            ...
            String upQry = "update tbl_shop set shop_status='2' where shop_id='" + request.getParameter("rid") + "'";
            if (con.executeCommand(upQry)) {
    ...
    %>
    <body>
        <h1 align="center" id="heading">Seller Data</h1>
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                <%                    int i = 0;
                    String selQry = "select * from tbl_shop c inner join tbl_place p on p.place_id=c.place_id inner join tbl_district d on d.district_id=p.district_id where shop_status='1'";
                ...
                <tr>
                    ...
                    <td align="center">
                        <a href="AcceptedShop.jsp?rid=<%=rs.getString("shop_id")%>"><img src="../Assets/Template/admin/remove.png"  width="25" height="25"></a>
                    </td>
                </tr>
                <%
                    }
