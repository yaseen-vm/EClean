...
<html>
    ...
    <%
        if (request.getParameter("id") != null) {
            String up = "update tbl_servicebooking set booking_status='" + request.getParameter("status") + "' where booking_id ='" + request.getParameter("id") + "'";
    ...
    <body>
        ...
        <table align='center' border="1" width="50%" >
            ...
            <%                int i = 0;
                String selQry = "select * from tbl_servicebooking b inner join  tbl_service s on s.service_id=b.service_id inner join tbl_user u on u.user_id=b.user_id where worker_id='" + session.getAttribute("wid") + "'";
            ...
            <tr>
                ...
                <td>
                    ...
                    %>
                    Payment Completed <a href="ServiceBooking.jsp?id=<%=rs.getString("booking_id")%>&status=1">Accept</a> | <a href="ServiceBooking.jsp?id=<%=rs.getString("booking_id")%>&status=2">Reject</a>
                    <%
